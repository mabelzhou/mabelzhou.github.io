...
import finsightImg from "../assets/finsight.png";
  ...
  const projects: Project[] = [
    {
      ...
      demo: true,
      tags: ["React", "Next.js", "TailwindCSS", "Gemini AI", "LLM", "Clerk", "Supabase", "Arcjet", "TypeScript"]
    },
    {
      image: finsightImg,
      name: "Finsight",
      description: "An AI-powered chatbot that provides real-time financial insights and analysis by combining GPT-4.1 with FMP API data.",
      link: "https://finsight-seven.vercel.app/",
      github: "https://github.com/mabelzhou/finsight",
      demo: true,
      tags: ["React", "Next.js", "TailwindCSS", "OpenAI", "LLM", "FMP API", "TypeScript", "Upstash"]
    },
    {
      image: spiceforgeImg,
      name: "Spice Forge",
